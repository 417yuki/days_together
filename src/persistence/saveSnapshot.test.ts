...
describe("save snapshots", () => {
  it("extracts only the stable map and character fields", () => {
    ...
    expect(snapshot).toEqual({ viewedMapId: "starter_house_interior", recentPartnerActionIds: [], worldStartedOn: initialState.worldStartedOn, unknownSprout: initialState.unknownSprout, characters: initialState.characters });
