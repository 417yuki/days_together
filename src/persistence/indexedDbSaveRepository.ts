...
import { normalizeCustomLocations, normalizeCustomMapName, parseCustomMapDraft, type CustomMapDraft, type CustomMapLocation, type CustomMapTargetId } from "../domain/maps/customMapDraft";
