...
import { createPresetItemSlots, restoreItemSlots, type MapItemSlotLayout } from "../maps/mapItemSlots";
...
export type MapVisualState = { saveSlotId: "main"; mapId: MapBackgroundId; backgroundAssetId: string | null; locationLayout: LocationLayout; gatewayVisual: MapGatewayVisual; itemSlots: MapItemSlotLayout; updatedAt: string };
...
export const parseMapVisual = (value: unknown, mapId: MapBackgroundId, itemIds: ReadonlySet<string> = new Set()): MapVisualState => {
