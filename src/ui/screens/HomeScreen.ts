...
import { SettingsScreen, type CharacterImageUi, type CharacterVisualUi, type MapBackgroundUi, type SettingsActions } from "./SettingsScreen";
...
export const HomeScreen = (state: AppState, actions: ScreenActions, itemImage?: ItemImageUi, characterImages?: Record<CharacterId, CharacterImageUi>, backgrounds?: Record<MapBackgroundId, MapBackgroundUi>, visuals?: Record<CharacterId, CharacterVisualUi>): HTMLElement => {
  ...
  if (state.activeNavigation === "map" && state.openEventId) {
    ...
    main.append(SettingsScreen(state, actions, characterImages, backgrounds, visuals!));
  } else {
