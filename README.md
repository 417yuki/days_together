...
Milestone 0、1、1.1、2、3、4、5、6、7、8Aまで完了しています。
...
次はMilestone 8B-1として、アイテム詳細からPNG、JPEG、WebPの個別画像を一枚追加、変更、削除し、IndexedDBへ安全に保存できるようにします。アイテム一覧は引き続き軽量な汎用アイコンを使用し、背景、キャラクターピン、カスタムマップは後の段階で扱います。詳細は `docs/NEXT_TASK.md` を参照してください。
