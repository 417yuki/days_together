...
Milestone 0、1、1.1、2、3、4、5、6、7まで完了しています。
...
次はMilestone 8Aとして、画像が一枚もなくても使えるアイテム基盤を実装します。ローカルSVGアイコン、カテゴリ自動選択、アイテム一覧、詳細、かんたん登録、IndexedDB保存までを対象とします。個別画像アップロード、キャラクターピン、背景、カスタムマップは次の段階です。詳細は `docs/NEXT_TASK.md` を参照してください。
